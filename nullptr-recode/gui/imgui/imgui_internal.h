...
enum ImGuiButtonFlags_
{
    ...
    ImGuiButtonFlags_SizeOnWindow = 1 << 19,
    ImGuiButtonFlags_MakeSpace    = 1 << 20,
    ImGuiButtonFlags_noPadY       = 1 << 21
};
...
struct ImGuiContext
{
    ...
    ImVector<ImGuiComboBox*> comboboxs;
...
struct IMGUI_API ImGuiComboBox
{
public:
    const char* name;
    ImVec2 size;
...
public:
    ...
    float       TitleBarHeight() const  { ImGuiContext& g = *GImGui; return (Flags & ImGuiWindowFlags_NoTitleBar) ? ((Flags & ImGuiWindowFlags_TitleBarLine) ? 4.0f : 0.f) : CalcFontSize() + g.Style.FramePadding.y * 2.0f; }
    ImRect      TitleBarRect() const    { return ImRect(Pos, ImVec2(Pos.x + SizeFull.x, Pos.y + TitleBarHeight())); }
    float       MenuBarHeight() const   { ImGuiContext& g = *GImGui; return (Flags & ImGuiWindowFlags_MenuBar) ? g.Style.MainBarSize : 0.0f; }
...
namespace ImGui
{
    ...
    IMGUI_API void          ColorEditOptionsPopup(float* col, ImGuiColorEditFlags flags);
