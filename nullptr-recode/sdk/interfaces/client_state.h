...
static_assert( FIELD_OFFSET(c_client_state, net_channel ) == 0x009C, "Wrong struct offset" );
static_assert( FIELD_OFFSET(c_client_state, current_sequence ) == 0x011C, "Wrong struct offset" );
static_assert( FIELD_OFFSET(c_client_state, delta_tick ) == 0x0174, "Wrong struct offset" );
