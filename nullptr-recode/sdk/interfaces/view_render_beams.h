...
public:
	...
	virtual void draw_beam(c_beam* pbeam, c_trace_filter* pEntityBeamTraceFilter = NULL) = 0;
	...
	virtual void create_beam_ent_point(int nStartEntity, const vec3* pStart, int nEndEntity, const vec3* pEnd,
		int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b) = 0;
	virtual void create_beam_points(vec3& start, vec3& end, int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b) = 0;
	...
	virtual void create_beam_ring_point(const vec3& center, float start_radius, float end_radius, int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b, int flags = 0) = 0;
	virtual void create_beam_circle_points(int type, vec3& start, vec3& end,
